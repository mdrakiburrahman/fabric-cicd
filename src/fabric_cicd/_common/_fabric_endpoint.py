    ...
    def invoke(
        ...
        **kwargs,
        ...
        Args:
            ...
            max_duration: Maximum duration in seconds for retry attempts. Defaults to 300 (5 minutes).
...
def _handle_response(
    ...
    Args:
        ...
        max_duration: Maximum duration in seconds for retry attempts.
...
def handle_retry(
    ...
    Args:
        ...
        max_duration: Maximum duration in seconds for retry attempts. If None, retries indefinitely.
    ...
    if max_duration is None or (start_time is not None and time.time() - start_time < max_duration):
        ...
        msg = f"Maximum retry duration ({max_duration} seconds) exceeded after {elapsed:.1f} seconds."
        raise Exception(msg)
